...
ktoolchain_src_prepare() {
	...
	case ${EAPI:-0} in
		5*) epatch_user;;
		6|7) eapply_user ;;
		*) die "Update ktoolchain_src_prepare() for ${EAPI}." ;;
	esac
...
has ktoolchain_death_notice ${EBUILD_DEATH_HOOKS} || EBUILD_DEATH_HOOKS+=" ktoolchain_death_notice"
ktoolchain_death_notice() {
