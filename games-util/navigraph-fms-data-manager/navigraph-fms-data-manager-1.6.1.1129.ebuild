...
RDEPEND="${DEPEND}
	...
	dev-qt/qtcore:5[abi_x86_64]
	dev-qt/qtgui:5[abi_x86_64]
	dev-qt/qtnetwork:5[abi_x86_64]
	dev-qt/qtxml:5[abi_x86_64]
	dev-qt/qtwidgets:5[abi_x86_64]"
...
src_install() {
	...
	insinto /usr
#	doins "/share/applications/Navigraph FMS Manager.desktop"
	make_wrapper "${PN}" /opt/navigraph/fms-data-manager/NGFMSManager
	make_desktop_entry \
